...
def _send_one(sub, title: str, body: str, url: str = '/dashboard'):
...
def push_to_user(user_id: int, title: str, body: str, url: str = '/dashboard'):
...
def push_to_admins(org_id: int, title: str, body: str, url: str = '/dashboard'):
    ...
    try:
        ...
        for admin in User.query.filter_by(organization_id=org_id, role='admin').all():
            push_to_user(admin.id, title, body, url)
    except Exception:
        pass
